...
public class Microservice extends PowerVm {
	...
	public Microservice(int id, String name, String appId, int userId, double mips, int ram, long bw, long size,
	...
	public Microservice(Microservice operator) {
