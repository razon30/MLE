...
public class SocialMediaApplication {
	 ...
	 */
	private List<Microservice> modules;
	 ...
	 * @return
	 */
	public static SocialMediaApplication createApplication(String appId, int userId) {
		return new SocialMediaApplication(appId, userId);
	}

	public static SocialMediaApplication createApplication(String appId) {
		return new SocialMediaApplication(appId);
	}
	...
	public SocialMediaApplication(String appId, int userId) {
		setAppId(appId);
		setUserId(userId);
		setModules(new ArrayList<Microservice>());
	...
	public SocialMediaApplication(String appId) {
		setAppId(appId);
		// setUserId(userId);
		setModules(new ArrayList<Microservice>());
		setEdges(new ArrayList<AppEdge>());
	...
	public SocialMediaApplication(String appId, List<Microservice> modules, List<AppEdge> edges, List<AppLoop> loops,
	 ...
	 * @return
	 */
	public Microservice getModuleByName(String name) {
		for (Microservice module : modules) {
	...
	public Tuple createTuple(AppEdge edge, int sourceDeviceId, int sourceModuleId) {
		Microservice module = getModuleByName(edge.getSource());
		if (edge.getEdgeType() == AppEdge.ACTUATOR) {
	...
	public List<Microservice> getModules() {
		return modules;
	}

	public void setModules(List<Microservice> modules) {
	...
	public Microservice addMicroservice(String moduleName, int ram, int mips, long size, long bw, String serviceType) {
		String vmm = "Xen";
		Microservice module = new Microservice(FogUtils.generateEntityId(), moduleName, appId, userId, mips, ram, bw,
				size, vmm, new TupleScheduler(mips, 1), new HashMap<Pair<String, String>, SelectivityModel>(),
				serviceType);
