...
public class ActuatorEndDevice extends SimEntity {
	...
	public ActuatorEndDevice(String name, int userId, String appId, int gatewayDeviceId, double latency,
	...
	public ActuatorEndDevice(String name, int userId, String appId, String actuatorType) {
		super(name);
		this.setAppId(appId);
		setUserId(userId);
		setMyActuatorType(actuatorType);
	...
	public ActuatorEndDevice(String name, String appId, String actuatorType) {
		super(name);
		this.setAppId(appId);
		// setUserId(userId);
		setMyActuatorType(actuatorType);
	...
	private void processTupleArrival(SimEvent ev) {
		...
		SocialMediaApplication app = getApp();
