...
public class CFSorter {
	...
	void merge(SDFCFogDevice[] arr, int l, int m, int r, List<Double> ETRList, List<Double> PRList, List<Double> RRList,
			List<Double> BRList) {
		...
		/* Create temp arrays */
		SDFCFogDevice L[] = new SDFCFogDevice[n1];
		SDFCFogDevice R[] = new SDFCFogDevice[n2];
		...
		while (i < n1 && j < n2) {
			...
			SDFCFogDevice left = L[i];
			SDFCFogDevice right = R[j];
	...
	void sort(SDFCFogDevice[] arr, int l, int r, List<Double> ETRList, List<Double> PRList, List<Double> RRList,
			List<Double> BRList) {
		if (l < r) {
	...
	static void printArray(SDFCFogDevice arr[]) {
		int n = arr.length;
		for (int i = 0; i < n; ++i) {
	...
	public static List<SDFCFogDevice> cfScheduler(List<SDFCFogDevice> list) {
		...
		List<SDFCFogDevice> childFogList1 = new ArrayList<>();
		// List<ChildFogSchedulerHelperModel> childFogSchedulerHelperModels = new
		// ArrayList<>();

		SDFCFogDevice[] childFogs = new SDFCFogDevice[list.size()];

		int p = 0;
		for (SDFCFogDevice childFog : list) {
