...
public class SDFCApplication {
	...
	public AppModule addAppModule(String moduleName, int rams, long mips, int bw, long storage) {
...
//		long mips = Utils.getValue(1024 * 1, 1024 * 2);
//		int rams = Utils.getValue((int) (1024 * 0.2), (int) (1024 * 0.5));
//		int bw = Utils.getValue((int) (1024 * 0.5), (int) (1024 * 1.5));
//		long storage = Utils.getValue(1024 * 10, 1024 * 15);

		String vmm = "Xen";
		AppModule module = new AppModule(FogUtils.generateEntityId(), moduleName, appId, userId, mips, rams, bw,
				storage, vmm, new TupleScheduler(mips, 1), new HashMap<Pair<String, String>, SelectivityModel>());
