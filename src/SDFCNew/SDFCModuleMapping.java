...
public class SDFCModuleMapping {
	/**
	 * Mapping from node name to list of <moduleName, numInstances> of instances to
	 * be launched on node
	 */
	protected Map<String, List<String>> moduleMapping;

	public static SDFCModuleMapping createModuleMapping() {
		return new SDFCModuleMapping();
	}
	...
	protected SDFCModuleMapping() {
		setModuleMapping(new HashMap<String, List<String>>());
	}

	/**
	 * Add <b>instanceCount</b> number of instances of module <b>moduleName</b> to
