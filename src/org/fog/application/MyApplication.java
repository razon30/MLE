...
public class MyApplication {
	...
	public static MyApplication createApplication(String appId) {
		return new MyApplication(appId);
	}
	...
	public MyApplication(String appId) {
		setAppId(appId);
		// setUserId(userId);
		setModules(new ArrayList<AppModule>());
		setEdges(new ArrayList<AppEdge>());
	...
	public MyApplication(String appId, List<AppModule> modules, List<AppEdge> edges, List<AppLoop> loops,
