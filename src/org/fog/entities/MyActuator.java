...
public class MyActuator extends SimEntity {
	...
	public MyActuator(String name, int userId, String appId, int gatewayDeviceId, double latency,
	...
	public MyActuator(String name, String appId, String actuatorType) {
		super(name);
		this.setAppId(appId);
		// setUserId(userId);
		setMyActuatorType(actuatorType);
