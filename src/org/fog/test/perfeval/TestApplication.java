...
public class TestApplication {
	public static Map<Integer, List<AppModule>> deviceToModuleMap = new HashMap<>();
	public static Map<Integer, MyFogDevice> CFbyIDHealthStatusTable = new HashMap<>();
	public static List<MyFogDevice> fogDevices = new ArrayList<MyFogDevice>();
	public static Map<Integer, MyFogDevice> deviceById = new HashMap<Integer, MyFogDevice>();
...
//			deviceToModuleMap.put(cloud.getId(), placedModules);
			...
			controller.submitApplication(application, 0,
					new MyModulePlacement(fogDevices, sensors, actuators, application, moduleMapping, "mainModule"));
